...
int main(void){
  ...
  LPC_PINCON->PINSEL0 = 0x00000000; // switch
    LPC_PINCON->PINSEL3 &= 0xFFC03FFF;//enable
    LPC_PINCON->PINSEL0=0x00000000;
    LPC_PINCON->PINSEL1=0x00000000;
  LPC_GPIO0->FIODIR = 0x007F8000;//configuring as output pins
    LPC_GPIO1->FIODIR |= 0x07800000;//enable

    
    while(1){
        k = LPC_GPIO0->FIOPIN >> 10; //We read input from 2.12
        k &= 0x00000001;
        delay();
        display();
        seg_count +=1;
